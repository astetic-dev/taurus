...
const I18N = {
  nl: {
    ...
    voice_install_hint: "Geen natuurlijke stemmen? Installeer ze via Windows-instellingen → Tijd en taal → Spraak → Stemmen beheren.",
  ...
  en: {
    ...
    voice_install_hint: "No natural voices? Install them via Windows Settings → Time & language → Speech → Manage voices.",
